...
- No parafrasees los nombres de variables, úsalos tal como están.
...
- Qué código es defensivo o boilerplate vs. lógica real.
...
Antes de terminar una sesión de lectura, responde esto:
