...
import './themes/ares-tactical-theme.css'
...
import SantaBarbaraTacticalComms from "./components/santa-barbara/SantaBarbaraTacticalComms.jsx";

const enableStrictMode = import.meta.env.VITE_REACT_STRICT_MODE !== 'false';

// Ctrl+Shift+T — toggle Ares OS tactical HUD theme
document.addEventListener('keydown', (e) => {
    if (e.ctrlKey && e.shiftKey && e.key === 'T') {
        e.preventDefault();
        document.body.classList.toggle('ares-tactical');
    }
});
        ...
        children: [
            {
                ...
                children: [
                    ...
                    {
                        path: "santa-barbara",
                        Component: SantaBarbaraTacticalComms,
                    },
                    {
